...
=== ${f} passed, ${v} failed ===`),v===0?u.window.showInformationMessage(u.l10n.t("OpenCode Grid API: All {0} tests passed!",f)):u.window.showWarningMessage(u.l10n.t("OpenCode Grid API: {0} test(s) failed. See output.",v))}),)}function Be(){H?.stop(),H=void 0,w.disposeAll()}0&&(module.exports={activate,deactivate});
